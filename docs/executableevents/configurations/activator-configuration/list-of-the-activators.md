---
description: Complete list of all activators supported by ExecutableEvents, organized by category (player, block, entity, miscellaneous). Use these activator names in your EE configuration files.
---
