...
### DESTROYED\_BY\_PISTON <CustomTag type="premium" />

* Info: Activates when the Executable Block detroyed by a piston.

### ENTITY\_WALK\_ON <CustomTag type="premium" />
...
### EXPLOSION\_HIT <CustomTag type="premium" /> 
...
### PLAYER\_PRESS\_PLATE <CustomTag type="premium" /> 
...
### PLAYER\_SCROLL\_DOWN\_BY\_TARGETTING\_THE\_EB <CustomTag type="premium" />

* Info: Activates when the player is looking at the eb and scrolls down

### PLAYER\_SCROLL\_UP\_BY\_TARGETTING\_THE\_EB <CustomTag type="premium" />
...
### PLAYER\_SPRINT\_ON <CustomTag type="premium" />  
...
### PROJECTILE\_HIT <CustomTag type="premium" />
...
### REDSTONE\_SIGNAL\_ENABLE <CustomTag type="premium" />
