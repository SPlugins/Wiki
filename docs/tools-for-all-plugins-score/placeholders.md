...
| **PLAYER_KILL_ENTITY** | `%last_hitter%`: Returns mob type of who dealt the last blow. This placeholder is relevant if you're trying to check whether you or your pet wolf dealt the last blow. Ex: `PLAYER`, `WOLF` |
